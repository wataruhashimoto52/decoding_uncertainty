...
from .embedding_calculator import EmbeddingsCalculator as CustomEmbeddingCalculator
...
from .greedy_probs import CustomGreedyProbsCalculator
from .sample import CustomSamplingGenerationCalculator
...
def register_stat_calculators(
    ...
    if isinstance(model, BlackboxModel):
        ...
        _register(CustomGreedyProbsCalculator(n_alternatives=n_ccp_alternatives))
        _register(EntropyCalculator())
        _register(GreedyLMProbsCalculator())
        _register(CustomSamplingGenerationCalculator())
        _register(BartScoreCalculator())
        _register(ModelScoreCalculator())
        _register(CustomEmbeddingCalculator())
